...
Since the edited code snippet provides a complete replacement, I will use it to overwrite the original content. Also, the line `IST = pytz.timezone('Asia/Kolkata')` has already been added in the original file, so I won't add it again. Instead, I will use the original code, incorporating the error handling and corrections described in the intention.
```python
<replit_final_file>
#!/usr/bin/env python3
"""

...
def _payload():
    # Minimal valid payload for validation
    return {
        "last_updated_utc": "2025-08-10T00:00:00Z",
        "market_session": "CLOSED",
        "timeframes": [{"timeframe": tf, "prediction_kpis": {}, "financial_kpis": {}, "risk_kpis": {}} for tf in ["All","3D","5D","10D","15D","30D"]],
        "ai_verdict_summary": {},
        "product_breakdown": {},

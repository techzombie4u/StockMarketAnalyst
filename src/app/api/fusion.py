...
from src.common_repository.utils.date_utils import get_ist_now, IST
from src.core.fusion.fusion_schema import (
    FusionDashboardPayload, MarketSession, Alert, AlertSeverity, TopSignal
)
from src.core.fusion.kpi_mapper import kpi_mapper  
from src.core.fusion.verdict_aggregator import verdict_aggregator
from src.core.fusion.pinned_rollup import pinned_rollup
...
def _load_kpi_data() -> Dict[str, Any]:
    ...
    try:
        from src.products.shared.services.kpi_service import kpi_service
...
def _load_predictions_data() -> list:
    ...
    try:
        # Try to load from predictions list endpoint
